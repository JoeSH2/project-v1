      ...
      <div className={classNames(style.ArticleCardSkeleton, {}, [className, style[view]])}>
        <Card className={style.card}>
          <div className={style.titleWrapper}>
            <Skeleton rounded={4} height="32px" width="400px" />
            <div className={style.userWrapper}>
              <Skeleton rounded="50%" height="45px" width="45px" className={style.avatar} />
              <Skeleton rounded={4} height="18px" width="180px" />
            </div>
          </div>
          ...
          <div className={style.btnWrapper}>
            <Skeleton rounded={4} width="120px" height="32px" className={style.btn} />
          </div>
    ...
    <div className={classNames(style.ArticleCardSkeleton, {}, [className, style[view]])}>
      <Card className={style.card}>
        <div className={style.wrapperIcon}>
          <Skeleton className={style.img} width="100%" height="270px" />
        </div>
        <div className={style.wrapperInfo}>
        ...
        <Skeleton height="32px" width="200px" className={style.title} />
      </Card>
    </div>
  );
};
